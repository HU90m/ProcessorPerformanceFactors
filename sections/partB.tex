...
\begin{subfigure}{.45\textwidth}
    \centering
    \includestandalone[width=\textwidth]{graphs/partb-assoc}
...
\begin{subfigure}{.4\textwidth}
    \centering
    \includestandalone[width=\textwidth]{graphs/partb-2d1-crc}
    \caption{CRC}
    \label{fig:partb-2d1-crc}
\end{subfigure}%
\hfill%
\begin{subfigure}{.4\textwidth}
    \centering
    \includestandalone[width=\textwidth]{graphs/partb-2d1-susan}
    \caption{SUSAN}
    \label{fig:partb-2d1-susan}
\end{subfigure}%
\hfill\null%
...
\begin{subfigure}{.4\textwidth}
    \centering
    \includestandalone[width=\textwidth]{graphs/partb-2d8-crc}
    \caption{CRC}
    \label{fig:partb-2d8-crc}
\end{subfigure}%
\hfill%
\begin{subfigure}{.4\textwidth}
    \centering
    \includestandalone[width=\textwidth]{graphs/partb-2d8-susan}
    \caption{SUSAN}
    \label{fig:partb-2d8-susan}
\end{subfigure}%
\hfill\null%
\caption{3D plots of the effects of cache association and cacheline size on miss rates, without data from association=1}
\end{figure}
