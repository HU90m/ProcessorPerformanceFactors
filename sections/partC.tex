...
effective enough to produce cycles per instruction values below one.~\cite{Dwyer1992}

Sadly, it is not all fine and dandy. As out of order execution demands a good
